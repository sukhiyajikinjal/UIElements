...
class RegisterVC2: UIViewController {
    ...
    private let bdate_lbl : UILabel = {
        ...
        bdate.font = UIFont(name: "HelveticaNeue-Bold", size: 22.0)
        bdate.textColor = .black
    ...
    private let bdate_dp :UIDatePicker = {
        ...
        dp.setValue(UIColor.red, forKey: "textColor")
        return dp
    }()
    ...
    private let age_lbl : UILabel = {
        ...
        age.text = "Age:"
        age.textColor = .black
        age.font = UIFont(name: "HelveticaNeue-Bold", size: 22.0)
